...
export default function Home() {
  ...
  const subjects: SubjectItem[] = useMemo(() => {
    ...
    curriculumData
      ...
      .forEach(item => {
        subjectMap.set(item.subject_id, { id: item.subject_id, name: item.subject_name });
      });
    ...
    <Layout>
      <Content>
        ...
        <CurriculumSelection 
          ...
          setSelectedChapterId={(chapterId: string | number) => setSelectedChapterId(Number(chapterId))}
        />
        <ExamResults 
